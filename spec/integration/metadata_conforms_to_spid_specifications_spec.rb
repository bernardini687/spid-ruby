...
RSpec.describe "Spid::Metadata conforms to SPID specification" do
  ...
  describe "Spid::CieMetadata" do
    let(:metadata) { Spid::CieMetadata.new }
    ...
    describe "#to_xml" do
      ...
      describe "EntityDescriptor node" do
        ...
        describe "ContactPerson node" do
          ...
          it "has the expected contactType attribute" do
            attribute = contact_person_node.attributes["contactType"].value
            expect(attribute).to eq "administrative"
          end
          ...
          it "has the expected Company element" do
            element = contact_person_node.children.find { |child| child.name == "Company" }
            expect(element.text).to eq "company"
          end
          ...
          describe "Extensions node" do
            ...
            it "has the expected Municipality element" do
              element = extensions_node.children.find { |child| child.name == "Municipality" }
              expect(element.text).to eq "municipality"
            end
          end
        end
      end
